...
public class Main {
    public static void main(String[] args) {
        ...
        // 차 객체의 타이어를 등록하는 메소드 호출한 후 반환값으로 차 객체의 타이어 객체 반환
        ...
        // 전달할 매개값으로 지정된 tire 인스턴스의 주소값이 전달되었기 때문에 호출된 메소드에 의해 값이 변경됨.

        // 메소드 실행 완료 후 반환된 car 인스턴스의 tire 객체 값이 반환되어 저장된 참조형 변수 carInstanceTire의 company 값 확인
